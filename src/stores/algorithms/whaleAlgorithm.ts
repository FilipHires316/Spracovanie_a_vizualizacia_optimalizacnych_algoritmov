...
const saveResult = (problemToSolve:
  ...
  const result = new HistoryEntry([], 'Veľryby', problemToSolve.getProblemType(), fitness, {count: count, capacity: capacity, averageWeight: averageWeight, averagePrice: averagePrice})
